        ...
        >
            <AppProviders>
                <div
                    className={cn(
                        "px-5",
                        "before:lg:absolute before:inset-x-0 before:top-12 before:w-full before:h-px before:bg-grid-line", // Top grid line
                        "after:lg:absolute after:inset-x-0 after:bottom-12 after:w-full after:h-px after:bg-grid-line" // Bottom grid line
                    )}
                    style={{
                        background:
