...
const Toolbar = (): ReactElement => {
    ...
    return (
        <div className="absolute inset-x-0 bottom-9 mx-auto px-2.5 py-1.5 w-fit flex gap-5 justify-between items-center bg-zinc-900/75 backdrop-blur-md border border-muted-foreground/15 rounded-full z-50">
            {/* Links */}
